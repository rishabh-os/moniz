...
void main() {
  ...
  test('migration from v1 to v2 does not corrupt data', () async {
    ...
    final oldCategoriesTableData = <v1.CategoriesTableData>[];
    final expectedNewCategoriesTableData = <v2.CategoriesTableData>[];

    final oldAccountsTableData = <v1.AccountsTableData>[];
    final expectedNewAccountsTableData = <v2.AccountsTableData>[];
    ...
    await verifier.testWithDataIntegrity(
      ...
      openTestedDatabase: MyDatabase.new,
      createItems: (batch, oldDb) {
        batch.insertAll(oldDb.transactionTable, oldTransactionTableData);
        batch.insertAll(oldDb.categoriesTable, oldCategoriesTableData);
